...
/// A minimal in-memory [VideoPlayerPlatform] so widget tests get a local player
/// that actually initializes.
///
/// Without one, `VideoPlayerController.initialize()` never completes under
/// `flutter test`, and anything that waits on the local player — picking
/// playback back up after a cast session ends, or
/// `ChewieController.swapVideoSource` — silently stalls.
