## [Unreleased]
* 👆 [#932](https://github.com/fluttercommunity/chewie/pull/932): Add `ChewieController.allowDoubleTapToggleFullScreen` (default `true`) to toggle fullscreen with a double tap on the video. Thanks [Ortes](https://github.com/Ortes).
